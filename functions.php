...
function nisarg_scripts() {
	wp_enqueue_style( 'nisarg-bootstrap-style', get_template_directory_uri().'/css/bootstrap.css' );

	wp_enqueue_style( 'nisarg-style', get_stylesheet_uri() );

	wp_enqueue_style( 'nisarg-font-awesome-style', get_template_directory_uri().'/font-awesome/css/font-awesome.min.css' );   
	
    wp_enqueue_script( 'nisargjquery-js', get_template_directory_uri() . '/js/jquery-2.1.4.js');
    wp_enqueue_script( 'nisarg-bootstap-js', get_template_directory_uri() . '/js/bootstrap.js');  

	wp_enqueue_script( 'nisarg-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );

	wp_enqueue_script( 'nisarg-js', get_template_directory_uri() . '/js/nisarg.js');  	
