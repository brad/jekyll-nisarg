...
function nisarg_custom_header_setup() {
	...
	register_default_headers( array(
		'wood' => array(
			'url'           => '%s/images/headers/wood.png',
			'thumbnail_url' => '%s/images/headers/wood_thumbnail.png',
			'description'   => _x( 'Wood', 'header image description', 'nisarg' )
		),
		'buildings' => array(
			'url'           => '%s/images/headers/buildings.png',
			'thumbnail_url' => '%s/images/headers/buildings_thumbnail.png',
