...
* Created by Falguni Desai- http://www.falgunidesai.com/

== Description ==

Nisarg is clean, blog-focused, fully responsive and translation ready theme. Use the theme customizer to add your own header image of flexible height, background image, to set background color, header backgound color and accent color(Supports seven different accent colors). Distinguish each post with one of the eight supported post formats, such as: Video, Image, Aside, Status, Audio, Quote, Link and Gallery. Uses Google Fonts for improved typeface readability and works perfectly in desktop browsers, tablets and handheld devices.
